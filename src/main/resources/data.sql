...
VALUES (1, 'A Tale of Two Cities', 1, 'Historical fiction1', false, 1),
       ...
       (6, 'The Hobbit', 6, 'Genre 2', true, 1),
       (7, 'The Lion, the Witch and the Wardrobe', 7, 'Genre 3', false, 1),
       (8, 'She: A History of Adventure	', 8, 'Genre 1', true, 1),
       (9, 'Vardi Wala Gunda', 9, 'Genre 2', false, 1),
       (10, 'The Da Vinci Code', 10, 'Genre 3', true, 1),
